...
<div class="row">
    <div class="col">
        <h1 class="tabindex" class="text-center pt-5"><?= __('Normas De Utilização', 'Rules of Use') ?></h1>
    </div>
</div>
                ...
                <div class="card-header" id="tituloUm">
                    <div class="mb-0">
                        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Bem-vindo ao CineFatec', 'Welcome to CINEFATEC') ?></span>
                        </button>
                    </div>
                </div>

                <div id="collapseOne" class="collapse show" aria-labelledby="tituloUm" data-parent="#accordion">
                    <div class="tabindex" class="card-body">
                ...
                <div class="card-header" id="tituloDois">
                    <div class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Política de Privacidade', 'Privacy Policy') ?></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-header" id="tituloTres">
                    <div class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Direitos Autorais', 'Copyright') ?></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-header" id="tituloQuadro">
                    <div class="mb-0">
                        <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Responsabilidade por nossos serviços', 'Responsibility for our services') ?></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-header" id="tituloCinco">
                    <div class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Direitos de propriedade', 'Property rights') ?></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-header" id="tituloSeis">
                    <div class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Vigência e rescição', 'Vigency and termination') ?></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-header" id="tituloSete">
                    <div class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Disposições gerais', 'General provisions') ?></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="card-header" id="tituloOito">
                    <div class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Direito de imagens', 'Right of images') ?></span>
                        </button>
                    </div>
                </div>
                <div class="tabindex" id="collapseEight" class="collapse" aria-labelledby="tituloOito" data-parent="#accordion">
                ...
                <div class="card-header" id="tituloNove">
                    <div class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                            <span class="tabindex" class="font-weight-bold text-uppercase"><?= __('Consequências e atualizações', 'Consequences and uptdates') ?></span>
                        </button>
                    </div>
                </div>
