        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p tabindex="0"><span class="badge badge-danger"><?= __('Alerta : essa postagem pode conter spoilers ', 'Alert: This post may contain spoilers') ?></span></p>
        ...
        <div class="col-md-12 col-sm-12 col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p tabindex="0"><span class="badge badge-danger">
                        <?= 
...
<div class="row p-2">
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xs-4">
        <div class="card mb-2">
            <div class="row no-gutters">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-4">
                    <img tabindex="0" src="images/annabelle3.jpg" class="card-img" alt="Essa é uma imagem da capa do filme Anabelle 3. Está capa exibe uma porta de um quarto em um ambiente escuro que está semi-aberta, é possível identificar uma claridade que está vindo de dentro do cômodo.">
                </div>
                <div class="col-md-8">
                <div class="card-body">
                    <h5 tabindex="0"  tabindex="0" class="card-title">
                        <?= 
                            ...
                            'Annabelle 3 (2019)') 
                        ?></h5>
                    <p tabindex="0" class="card-text"><small class="text-muted"><?= __('Última atualização 3 minutos atrás', 'Last updated 3 mins ago') ?></small></p>
                </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xs-4">
        <div class="card mb-2">
            <div class="row no-gutters">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-4">
                    <img tabindex="0" src="images/coringa.jpg" class="card-img" alt="Essa é uma imagem da capa do filme Coringa. Na capa está sendo exibido somente o rosto do palhaço maníaco, olhando para cima.">
                </div>
                <div class="col-md-8">
                <div class="card-body">
                    <h5 tabindex="0"  tabindex="0" class="card-title">
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xs-4">
        <div class="card mb-2">
            <div class="row no-gutters">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-4">
                    <img tabindex="0" src="images/projetogremini.jpg" class="card-img" alt="Essa é uma imagem da capa do Filme Projeto Gemini.Na capa está sendo exibido o rosto do personagem principal Henry Brogan, representado pelo ator Will Smith. O rosto do personagem demonstra preocupação.">
                </div>
                <div class="col-md-8">
                <div class="card-body">
                    <h5 tabindex="0"  tabindex="0" class="card-title">
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xs-4">
        <div class="card mb-2">
            <div class="row no-gutters">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-4">
                    <img tabindex="0" src="images/ving-ultimato-2.jpg" class="card-img" alt="Essa é uma imagem da capa do filme Os Vingadores Ultimato, nessa capa, está sendo exibido os seguintes heróis do filme. Capitão América, Capitã Marvel, Homem-Formiga, Viúva Negra, Nebulosa,Okoye, Hulk, Rocket e o Thor.">
                </div>
                <div class="col-md-8">
                <div class="card-body">
                    <h5 tabindex="0"  tabindex="0" class="card-title">
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xs-4">
        <div class="card mb-2">
            <div class="row no-gutters">
                <div class="col-sm-12 col-md-12 col-lg-4 col-xs-4">
                    <img tabindex="0" src="images/aladin.jpg" class="card-img" alt="Essa é uma imagem do filme Alladin, nessa imagem está sendo exibido os seguintes personagens: Alladin, Gênio,o Macaquinho de estimação Abu e a Princesa Jasmine">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 tabindex="0"  tabindex="0" class="card-title">
