...
<div class="row mt-5">
    <div class="col">
        <h1 tabindex="0" class="display-4"><?= __('Notícias', 'News') ?></h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-6">
        <div class="card-block px-2 d-flex flex-column">
            ...
            <div tabindex="0" class="btn-compartilhar">
            ...
            <p tabindex="0" class="card-text ">
                Aquaman é um filme de super - herói estadunidense de 2018, baseado no personagem homônimo da DC Comics,
                distribuído pela Warner Bros. Pictures, sendo o sexto filme do Universo Estendido DC. O filme é dirigido
                por James Wan, com um roteiro de Will Beall e David Leslie, a partir de uma história de Wan, Johns e Beall 
                [...]
            </p>
        </div>
    </div>
    <div class="col-lg-6">
        <img tabindex="0"  src="images/Aquaman.jpg" alt="Poster do filme aquaman, com ele em primeiro plano" class="w-100">
    </div>
</div>
<div class="row mt-5">
    <div class="col-lg-6 mb-4">
        <img tabindex="0"  src="images/capitamarvel.jpg" alt="poster do filme da capitã marvel, com ela em primeiro plano" class="w-100">
    </div>
    <div class="col-lg-6">
        <div class="card-block px-2 d-flex flex-column ">
            <a href="#" role="button" class="text-hover-gray">
            ...
            <p tabindex="0" class="card-text ">
                Capitã Marvel é um filme estadunidense de super-herói de 2019, baseado na personagem Carol Danvers da Marvel
                Comics, produzido pela Marvel Studios e distribuído pela Walt Disney Studios Motion Pictures, sendo o vigésimo
...
<div class="row mt-5">
    <div class="col-lg-6">
        <div class="card-block px-2 d-flex flex-column">
            ...
            <p tabindex="0" class="card-text ">
                Dumbo é um filme de aventura e fantasia estadunidense de 2019, dirigido por Tim Burton e escrito por Ehren
                Kruger, sendo o remake em live-action do longa-metragem animado Dumbo, de 1941, baseado no enredo escrito
                por Helen Aberson e ilustrado por Harold Pearl. Produzido pela Walt Disney Pictures e Tim Burton Productions
                e distribuído pela Walt Disney Studios Motion Pictures, é estrelado por Colin Farrell, Eva Green, Michael
                Keaton, Danny DeVito e Alan Arkin [...]
            </p>
        </div>
    </div>
    <div class="col-lg-6 mb-4">
            <img tabindex="0"  src="images/Dumbo.jpg" alt="Poster do filme Dumbo com ele no primeiro plano" class="w-100">
    </div>
</div>
<div class="row mt-5">
    <div class="col-lg-6 mb-4">
        <img tabindex="0"  src="images/homemaranha.jpg" alt="poster do filme do homem aranha com ele no primeiro plano" class="w-100">
    </div>
    <div class="col-lg-6">
        <div class="card-block px-2 d-flex flex-column">
            <a href="#" role="button" class="text-hover-gray">
            ...
            <p tabindex="0" class="card-text ">
                Homem Aranha no Aranhaverso é um filme de aventura de um jovem chamado Piter Parker que,
                em um momento, encontra outras versões de si mesmo de outros universos [...]
            </p>
        </div>
    </div>
</div>
